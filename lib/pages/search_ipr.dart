...
class SearchIPR extends StatefulWidget {
  SearchIPR();

  @override
  State<SearchIPR> createState() => _SearchIPRState();
}

class _SearchIPRState extends State<SearchIPR> {
  ...
  Future<void> checkbypincode(String pincode) async {
    ...
    DocumentSnapshot docsnap = await FirebaseFirestore.instance
        .doc("users/${FirebaseAuth.instance.currentUser.uid}/forms/${pincode}")
        .get();
    if (docsnap.exists) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute<void>(
          builder: (BuildContext context) => SHowIPR(data),
        ),
      );
    } else {
      Fluttertoast.showToast(msg: "Sorry!!! No IPR with this ID");
    }
  }
