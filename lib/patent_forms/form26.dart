...
class PatentForm26 extends StatefulWidget {
  PatentForm26(this.applicationid);
  String applicationid;
  @override
  State<PatentForm26> createState() => _PatentForm26State();
}

class _PatentForm26State extends State<PatentForm26> {
