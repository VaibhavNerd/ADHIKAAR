...
class PatentForm5 extends StatefulWidget {
  PatentForm5(this.applicationid);
  String applicationid;
  @override
  State<PatentForm5> createState() => _PatentForm5State();
}

class _PatentForm5State extends State<PatentForm5> {
                    ...
                    onPressed: () {
                      if (_formKey.currentState.validate() && url != "") {
                        ...
                        FirebaseFirestore.instance
                            ...
                            .set({"form5": data}, SetOptions(merge: true)).then(
                                (value) {
